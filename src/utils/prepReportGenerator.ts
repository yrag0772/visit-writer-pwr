...
export function generatePrepReport(prepData: PrepData): string {
  ...
  const detailChildrenHtml = Array.from({ length: prepData.childCount })
    ...
    <div style="border: 1px dotted #94a3b8; padding: 8px; margin-bottom: 8px;">
      ...
      <p>► 發展檢核： □ 正常　□ 異常　□ 未滿3個月16天，無法施作　□ 本階段已施作　□ 其他：________</p>
  ...
  add(
    ...
    <p>5.2 適齡的餵食或用餐方式（若收托2位以上托兒，請說明餵食流程）： □ 符合　□ 不符合　□ 現況及說明(其他)：________</p>
    ...
    <p>7. 托育人員是否幫幼兒洗澡： □ 是　□ 否　□ 現況及說明：________</p>
    <br/>
    <p>8. 照顧品質評估指標檢核： □ 符合　□ 不符合　待觀察項目：________</p>
    <p>9. 居家托育人員收托4名兒童訪視檢核表： □ 符合　□ 不符合</p>
  ...
  add(
    "十四、保親關係",
    `
    <p>1. 每日交接方式：__________________</p>
    <p>2. 保親合作狀況：__________________</p>
  `,
  );
  ...
  add(
    "十五、托育人員現況",
    `
    <p>1. 托育人員自述健康狀況：__________________</p>
    <p>2. 訪員評估： □ 無明顯風險　□ 異常 (□ 呈現焦慮與壓力感 □ 呈現衝動與控制力較差 □ 表情冷漠或社交退縮 □ 有獨留兒童在家之風險 □ 同住家人關係衝突 □ 其他：________)</p>
    <p>3. 同住成員身心狀況與家庭狀況： □ 無明顯異常　□ 尚可　□ 無同住成員　□ 訪視未遇家庭成員　□ 不佳 ／ 說明：________</p>
    <p>4. 同住成員是否支持： □ 是　□ 否 ／ 說明：________</p>
    <p>5. 托育工作是否影響家庭生活： □ 否　□ 是 ／ 說明：________</p>
  `,
  );
